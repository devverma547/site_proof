...
import { formatAiFixPrompt, getVibeTranslation, getVibeVerdict, calculateProjectedScore } from '../../utils/reportScoring';
...
export default function SampleReportPage() {
  ...
  const projectedScore = calculateProjectedScore(targetScore, recommendations, null);
  ...
  return (
    <div className="w-full flex-1 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-8 relative">
      <Helmet>
              ...
              {recommendations.map((item, idx) => (
                <div key={idx}
                  ...
                  <div className="flex items-center gap-4 justify-between md:justify-end shrink-0">
                    ...
                    <button onClick={() => setActiveFixModal({
                      ...item,
                      prompt: formatAiFixPrompt(domainName, item.title, item.detail, githubRepoUrl)
                    })}
        ...
        {targetScore > 0 && recommendations.length > 0 && (
            ...
            >
              ...
              <div className="flex items-center justify-between p-5 border-b border-slate-200 dark:border-white/10 shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 id="sample-fix-modal-title" className="text-base font-bold text-slate-900 dark:text-white">✨ Fix Simulator</h3>
